export default function bookingConfirm(booking, driver, vehicle_details) {
  return `<!DOCTYPE html>
  <html>
  ...
  <body>
      <div class="container my-4">
          <div class="mail-container mx-auto">
              ...
              <div class="fw-bold fs-sm my-3">Driver Details</div>
                ...
                ${
                  ...
                  ` <tr>
                    <td colspan="2" class="text-center">
                      <img src="${driver.photo_url}" class="driver-image"/>
                    </td>
                  </tr>`
                }
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>${driver?.vehicle_details}
                            </p>
                        </td>
                    </tr>
                </tbody>
          </table>
              <div class="fw-bold fs-sm my-3">Passenger Details</div>
    ...
    vehicle_details.luggage_capacity
  }
                              </p>
                          </td>
                      </tr>
